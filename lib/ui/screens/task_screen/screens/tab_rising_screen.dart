...
class RisingScreen extends StatefulWidget {
  final List<GeneralResponse?> myList;
  const RisingScreen( {Key? key, required this.myList}) : super(key: key);

  @override
  State<RisingScreen> createState() => _RisingScreenState();
}

class _RisingScreenState extends State<RisingScreen> {
  TextEditingController RisingTextEditingController = TextEditingController();
